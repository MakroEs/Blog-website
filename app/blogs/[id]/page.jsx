    ...
    <div className='bg-gray-200 py-5 px-5 md:px-12 lg:px-28'>
      ...
      <div className='mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10'>
          <Image className='border-4 border-white' src={data.image} alt='' width={1280} height={720} />
           ...
           <p className='my-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia nihil nulla fuga iure quisquam rem.</p>
           <p className='my-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia nihil nulla fuga iure quisquam rem.</p>
           <h3 className='my-5 text-[18px] font-semibold'>Setp 2:Self-Reflection and Goal Setting</h3>
           <p className='my-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia nihil nulla fuga iure quisquam rem.</p>
           <p className='my-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia nihil nulla fuga iure quisquam rem.</p>
           <h3 className='my-5 text-[18px] font-semibold'>Conclusion:</h3>
           <p className='my-3'>Managing your lifestyle is a journey that lla fuga iure quisquam rem.</p>
           <p className='my-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia nihil nulla fuga iure quisquam rem.</p>
            <div className='my-24'>
              <p className='black font-semibold my-4'>Share this article on social media</p>
              <div className='flex'>
